...
View the [sample copy spreadsheet](https://docs.google.com/spreadsheet/pub?key=0AtDkI4IR-2tndG9kX3NEck56Z085SkNvZnUwZTU4c2c#gid=0).
...
def read_my_google_doc():
    ...
    get_document('0AtDkI4IR-2tndG9kX3NEck56Z085SkNvZnUwZTU4c2c', file_path)
    data = Copy(file_path)
...
```
* * * * * ubuntu bash /home/ubuntu/apps/bestsongs15_midyear/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test
```
...
|bestsongs15-midyear|open-share-discuss||
|bestsongs15-midyear|close-share-discuss||
